...
#from customMatMul import matrix_multiply

@onnx_op(op_type="CustomQGemm",
...
def CustomQGemmOp(A, A_scale, A_zeroPoint, B, B_scale, B_zeroPoint, C,  C_scale, C_zeroPoint):
    """
    ...
    #matmul_result = matrix_multiply(A_centered, B_centered)
